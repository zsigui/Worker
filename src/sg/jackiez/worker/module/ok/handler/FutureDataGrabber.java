        ...
        mKlineGrabThread = new DefaultThread(() -> {
            ...
            while (mIsKlineGrabRunning) {
                ...
                if (_1minKlines != null && !_1minKlines.isEmpty()) {
                    if (mStoreKlinesMap.get(OKTypeConfig.KLINE_TYPE_1_MIN) == null
                            || !CompareUtil.equal(_1minKlines.get(999), mStoreKlinesMap.get(OKTypeConfig.KLINE_TYPE_1_MIN).get(999))) {
                ...
                if (_15minKlines != null && !_15minKlines.isEmpty()) {
                    if (mStoreKlinesMap.get(OKTypeConfig.KLINE_TYPE_15_MIN) == null
                            || !CompareUtil.equal(_15minKlines.get(999), mStoreKlinesMap.get(OKTypeConfig.KLINE_TYPE_15_MIN).get(999))) {
